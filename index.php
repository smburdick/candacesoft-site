...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><!--<img class="navbar-brand navbar-logo" src="img/cropped-Candace-Soft-Logo.jpg">--> Candace Software</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Innovative solutions for better coffee</div>
      ...
      <div class="container">
        <div class="row">
          ...
          <!--      <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3> -->
            ...
            <p>
            <p class="text-center">
              We are recruiting talented individuals to help us create
              integrated software solutions for coffee producers, distributors, and retailers. If you are
              specialized in this field and would like to contribute to our success, <a class="page-scroll" href="#contact">we would love to hear from you</a>.
            </p>
            <p class="text-center">
              Based in Lynnwood, Washington State, USA
            </p>
        </div>
      </div>
        <!--
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">&copy;2017 Candace Software</span>
                </div>
          <!--      <div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
